...
function Home(){
  ...
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
    ...
    <View style={s.grid}>{items.map(([title,sub],i)=><View key={title} style={s.card}><View style={[s.dot,{backgroundColor:[colors.pink,colors.orange,colors.yellow,colors.purple][i]}]}/><Text style={s.cardTitle}>{title}</Text><Text style={s.cardSub}>{sub}</Text></View>)}</View>
