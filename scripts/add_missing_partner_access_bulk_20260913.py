...
anchor='  <div class="card"><div class="row"><div><h2>Partner Subscriptions</h2>'
if anchor not in s:
    raise SystemExit('subscription card anchor missing')
