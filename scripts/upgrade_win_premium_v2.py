...
@media(max-width:380px){.winGiftGallery{grid-template-columns:repeat(2,minmax(0,1fr))!important}.winGiftGalleryHead h2{font-size:25px!important}}
'''
s=s.replace('</style>',css+'</style>',1)
# Add a compact intro card immediately before gallery, without touching existing wins/history.
